...
def step_one(ticker_info):
    ...
    if tic not in ['BTC', 'ETH']:
        print(tic)
        print("Making Impute Data...")
        raw_merged_feather = pd.read_feather(path)
        #raw_merged_feather.reset_index(inplace=True, drop=True)
        temp=raw_merged_feather[raw_merged_feather.participant_timestamp<'2017-05-01'].copy()
        ...
        print("Impute Data Done, Starting Bars resampling...")
