...
def kit_update(ticker_info):
    
    
    print(ticker_info)
    tickerr=ticker_info['name']
    year = date.today().year
    current_folder = f'./docker_storage/Time_Data_New/{tickerr}_{year}/'
#     print(os.listdir('./docker_storage/Time_Data_New/'))
#     print(year)
    # print(today)
