...
#         print('start_date',start_date)
  ...
  ############################################################################################
    ...
    path='./docker_storage/'
    pathh = './docker_storage/after_raw_data/'
...
#             print('raw_path',raw_path)
            ...
            file_path = f'./docker_storage/after_raw_data/{ticker}_{year}/{ticker}_{curr_date[0]}_Tick-Data.ftr' 
            raw_path = f'./docker_storage/after_raw_data/{ticker}_{year}/'
#             print('raw_path',raw_path)
...
#                         print(f"./docker_storage/Raw_Data_New/{ticker}_{year}/{ticker}_{curr_date[0]}_Tick-Data.ftr")
                        df.to_feather(f"./docker_storage/after_raw_data/{ticker}_{year}/{ticker}_{curr_date[0]}_Tick-Data.ftr")
#                         print('zero')
                        del df
                    else:
...
#                         print(f"./docker_storage/Raw_Data_New/{ticker}_{year}/{ticker}_{curr_date[0]}_Tick-Data.ftr")
                ...
                dir_list1 = os.listdir(f"./docker_storage/after_raw_data/{ticker}_{year}")
                if not os.path.exists(file_path):
...
#                     continue
                    ...
                    if len(df) != 0:
                        ...
                        df = df.reset_index()
                        df["participant_timestamp"] = df["participant_timestamp"]
                        print(f"./docker_storage/after_raw_data/{ticker}_{year}/{ticker}_{curr_date[0]}_Tick-Data.ftr")
