...
# ...[rest of your code above the for loop]
            ...
            for index, i in enumerate(list(data_dict.keys())):  # Convert keys to list before iteration
                ...
                file_path = f'./docker_storage/Time_after/{tickerr}_{year}/{tickerr}_{curr_date[0]}_Time_Tick-Data.ftr'
                raw_path = f'./docker_storage/Time_after/{tickerr}_{year}/'
                ...
                if not os.path.exists(file_path):
                    if len(df) != 0:
                        ...
                        df = df.between_time('15:30', '19:30')
