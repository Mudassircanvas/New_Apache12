...
def make_all_features(tic):
    ...
    try:
        print('------------------------------------------------------------------')
        print(tic)
        df = pickle.load(open(f'/storage/docker_storage/Tick_Data/Const_Resampled_2017/dolDF_const_10_BarsPerDay_wFeats/{tic}_dolDF_const_10_BarsPerDay_wFeats.pkl', 'rb'))
    ...
    #### new 22
        ...
        secDict[tic].to_csv(f'/storage/docker_storage/Tick_Data/Const_Resampled_2017/dolDF_const_10_BarsPerDay_wFeatsAndTgtsAndEvents/FullDataDict_400NbarLim{tic}.csv')
