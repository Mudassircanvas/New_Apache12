...
#     print(da)
    ...
    da.to_csv(f"./docker_storage/features/{tickerr}_exe1.csv")
...
#     combined_df = df2.merge(df1, left_on='t', right_on='Unnamed: 0', how='outer')
...
#     di = pd.read_csv(f'./docker_storage/features/{ticker}_execution11.csv')
    print('done')
#     print(di)
#     return da
