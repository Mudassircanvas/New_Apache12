...
# #                 print(f"Updated data for date -> {curr_date[0]}")
# #                 del df
...
# #     return ticker_info
# ''' the above code is actuall code 2 jan 2024 '''
...
#     # Paths for current and previous year data
#     current_folder = f'./docker_storage/Raw_Data_New/{ticker}_{current_year}/'
#     previous_folder = f'./docker_storage/Raw_Data_New/{ticker}_{previous_year}/'

#     # Check if current year data exists, else use previous year
#     if os.path.exists(current_folder):
#         data_folder = current_folder
#     elif os.path.exists(previous_folder):
#         data_folder = previous_folder
#         print(f"Using data from previous year: {previous_year}")
#     else:
#         print('No past data exists for the current or previous year.')
#         return
...
#                 del data_dict[curr_date[0]]
    raw_path = f'./docker_storage/Raw_Data_New/{ticker}_{year}/'
    path_loc =  [f'./docker_storage/Raw_Data_New/{ticker}_2023/',f'./docker_storage/Raw_Data_New/{ticker}_2024/']
    year_path = ['2023','2024']
    ticker_info = {"name" : ticker, "path" : path_loc,'year_path':year_path}
    print(ticker_info)
    return ticker_info
