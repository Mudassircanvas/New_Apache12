...
# # #         print(start)
# #         start = str(ticker_info['start_date'])
# #         prev_date = str(ticker_info['end_date'])
# #         start_date = start
# #         end_date = prev_date
# #         print('p',prev_date)
# # #      
...
# #                 file_path = f'./docker_storage/Time_Data_New/{tickerr}_{year}/{tickerr}_{curr_date[0]}_Time_Tick-Data.ftr'
# #                 raw_path = f'./docker_storage/Time_Data_New/{tickerr}_{year}/'
...
# #     return ticker_info
# #             # ...[rest of your code]
#  #### Above code was actual code 4 jan
...
#     path_loc =  raw_list
# #     year_path = yearl
#     ticker_info['path'] = path_loc 
# #     ticker_info = {"name" : tickerr, "path" : path_loc,'start_date':start_date,'end_date':end_date,}
#     print(ticker_info)
#     return ticker_info
#             # ...[rest of your code]
# ACUTALL CODE ABOVE ... # 8 JAN
